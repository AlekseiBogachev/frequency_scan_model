...
по вычисленным параметрам моделей.
	...
	Построим спектр идентифицированного частотного скана (рисунок 
	...
	На рисунке \ref{pic:spectr_single_exp_ideal_263} приведён спектр 
	идентифицированного частотного скана.
	...
	На рисунке \ref{pic:multi_exp_spectr_263} приведён спектр 
	идентифицированного частотного скана.
