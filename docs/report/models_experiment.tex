...
модели на тестовом наборе, и обойтись только оценками корня из 
...
разными моделями, сравнение результатов, а также анализ графиков Аррениуса,
построенных по вычисленным параметрам моделей.
